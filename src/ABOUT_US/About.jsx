    ...
    <section className='text-white mt-20'>
            ...
            <div className='flex flex-col lg:flex-row items-center gap-4 justify-between mx-3 lg:mx-10 xl:mx-28 2xl:mx-56'> 
                        ...
                        <div className='flex flex-col gap-4'>
                                ...
                                <button className='mt-3 mx-auto lg:mx-0 bg-gradient-to-r hover:bg-gradient-to-l duration-500 hover:scale-105 to-blue-500 from-pink-500 h-[45px] w-[150px] rounded-lg'>
                                 Discover More
                                </button>
                        </div>
            </div>
