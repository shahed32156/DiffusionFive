  ...
  return (
    <footer className="bg-gray-900 text-white py-10 mt-20">
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className='mx-auto'>
          ...
          <ul className="space-y-2">
            <li><a href="#" className="hover:pl-2 hover:text-blue-500 duration-500">Home</a></li>
            <li><a href="#" className="hover:pl-2 hover:text-blue-500 duration-500">About</a></li>
            <li><a href="#" className="hover:pl-2 hover:text-blue-500 duration-500">Services</a></li>
            <li><a href="#" className="hover:pl-2 hover:text-blue-500 duration-500">Team</a></li>
            <li><a href="#" className="hover:pl-2 hover:text-blue-500 duration-500">Portfolio</a></li>
            <li><a href="#" className="hover:pl-2 hover:text-blue-500 duration-500">Contact</a></li>
          </ul>
        </div>
        ...
        <div className='mx-auto sm:mx-0'>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="hover:pl-2 hover:text-blue-500 duration-500">FAQ</a></li>
      ...
      <div className="mt-8 border-t border-gray-700 pt-4 text-center">
        <p className="text-gray-400">Copyright &copy; 2024 DiffusionFive. All rights reserved.</p>
      </div>
    </footer>
  );
};
